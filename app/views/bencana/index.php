<div class="container py-5 px-4 bg-white">
    <div>
        ...
        <div class="d-flex justify-content-between">
            <h3><?= $data['judul']; ?></h3>
            <a href="<?= BASEURL; ?>/bencana/create" class="btn btn-primary mb-3">Tambah Data Bencana</a>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-sm table-hover border">
                <thead class="text-secondary text-center align-middle">
                    <tr>
                        <th class="fw-normal" scope="col">Jenis Bencana</th>
                        <th class="fw-normal" scope="col">Tanggal</th>
                        <th class="fw-normal" scope="col">Provinsi</th>
                        <th class="fw-normal" scope="col">Kabupaten/Kota</th>
                ...
                <tbody class="align-middle text-center">
                    <tr>
                        ...
                        <td scope="row">
                            <a 
                                href="<?= BASEURL; ?>/bencana/detail" 
                                class="btn btn-outline-success" 
                                data-bs-toggle="tooltip" data-bs-placement="top" title="Detail Bencana"
                            >
                            ...
                            <a 
                                href="<?= BASEURL; ?>/bencana/edit" 
                                class="btn btn-outline-primary"
                                data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Bencana"
                            >
                            ...
                            <a  href="<?= BASEURL; ?>/bencana/delete"
                                class="btn btn-outline-danger"
                                onclick="return confirm('Yakin untuk menghapus?');"
                                data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus Bencana"
                            >
